![캡처](https://github.com/user-attachments/assets/56bf1046-a658-45b8-a01e-0654bbeaadf4)

# 👋 소개
안녕하세요. 4년차 PHP 개발자 안민성입니다.<br>
쇼핑몰, 이벤츠팩(커스텀 웹 제작 프로그램), 제니스(광고 관리 프로그램) 등 다양한 프로젝트에 참여하며 풀스택 개발 역량을 쌓았습니다.<br>
프론트엔드와 백엔드를 모두 다룰 수 있으며, **책임감**을 바탕으로 항상 최선을 다해왔습니다. 앞으로도 기업에 큰 기여를 하고자 합니다.<br>
감사합니다.
