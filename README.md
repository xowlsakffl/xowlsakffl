...
에드테크·이커머스·플랫폼 등 다양한 도메인에서<br>
서비스 설계, 유지보수, API 통합, 데이터 처리 중심으로 개발 경험을 쌓았습니다.<br>
특히 에드테크 - 광고 운영 자동화(조건부 스케줄러, 캠페인 제어, 실시간 성과 수집) 분야에 강점이 있습니다.<br>
