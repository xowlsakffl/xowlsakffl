...
지난 4년 동안 쇼핑몰, 이벤츠팩(커스텀 웹 제작 프로그램), 제니스(광고 관리 프로그램) 등의 다양한 프로젝트에 참여하여 전문성을 쌓았습니다. 저는 풀스택 개발자로서 프론트엔드 역량도 함께 갖추고 있어, 전반적인 웹 개발에 강점을 가지고 있습니다.
저는 프로젝트를 진행할 때마다 **책임감**을 가장 중요한 가치로 여기며, 항상 최선을 다해 임했습니다. 이러한 책임감을 통해 성공적인 결과를 도출해왔으며, 앞으로도 이를 바탕으로 기업에서 큰 기여를 하고자 합니다. 감사합니다.
